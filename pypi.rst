...
-  `Basic <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/basic.py>`_ - a introduction to the basic use of
   pylabels.
-  `Partial pages <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/partial_page.py>`_ - how to produce partial
   pages (i.e., pages with some of the labels previously used).
-  `Background colours <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/background_colours.py>`_ - examples of solid,
   striped and hatched backgrounds of different colours on each label.
-  `Page background <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/page_background.py>`_ - how to add a background
   image for each page.
-  `Padding <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/padding.py>`_ - how to add padding to the labels.
-  `Nametags <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/nametags.py>`_ - creates a set of nametags from the
   list of names in the names.txt file. Includes the use of two custom
   fonts, font size selection, and centred text.
-  `Image preview <https://github.com/blairbonnett/pylabels/blob/1.1.1/demos/preview.py>`_ - generates image previews of
